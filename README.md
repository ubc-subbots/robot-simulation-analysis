...
2. Change the top level variables in `calculate_parameters.py` to the appropriate file names and run it. This will do the calculations and print out the added mass matrix, center of buoyancy, and volume which you can copy into the `.sdf` file.
